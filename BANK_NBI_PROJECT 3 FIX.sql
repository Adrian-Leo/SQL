...
create table human.NASABAH(
	NO_REK varchar (15) not null primary key, 
		constraint pkNO_REK
...
Exec InsertPENDAFTARAN_NASABAH @ID_NASABAH='N0000000009',@ID_PEG='C002',
@NAMA_NASABAH='yanto',@EMAIL='yanto@gmail.com',@TANGGAL_LAHIR='2001-09-12',@TEMPAT_LAHIR='JAKARTA',
...
as
	...
	END
exec InsertNASABAH '7000000005','N0000000009','0'
select * from human.NASABAH
...
exec insertTARIK 'TRK05','7000000005','5000000','2019-09-08','T002'
...
exec InsertSETOR 'STR005','7000000421','10000000','2019-11-08','T003'
...
AS
	...
	update human.NASABAH set human.NASABAH.SALDO = human.NASABAH.SALDO - inserted.JUMLAH_TARIK
...
/*View procedure nasabah*/
create procedure view_SALDO
@id varchar(20)
as
SELECT human.NASABAH.NO_REK,PENDAFTARAN_NASABAH.NAMA_NASABAH, human.NASABAH.SALDO

from human.PENDAFTARAN_NASABAH INNER JOIN
	 human.NASABAH ON human.PENDAFTARAN_NASABAH.ID_NASABAH = human.NASABAH.ID_NASABAH 

where human.PENDAFTARAN_NASABAH.NAMA_NASABAH= @id
DROP PROCEDURE view_SALDO
exec view_SALDO 'yanto'

/*PROCEDURE VIEW_TRANSAKSI*/
create procedure view_TRANSAKSI_SETOR
@id1 char(20)
AS
SELECT human.PENDAFTARAN_NASABAH.NAMA_NASABAH,human.NASABAH.NO_REK,transaksi.SETOR.JUMLAH_SETOR,
	transaksi.SETOR.TANGGAL_SETOR
FROM human.PENDAFTARAN_NASABAH INNER JOIN
	 human.NASABAH ON human.PENDAFTARAN_NASABAH.ID_NASABAH = human.NASABAH.ID_NASABAH INNER JOIN 
	 transaksi.SETOR ON human.NASABAH.NO_REK=transaksi.SETOR.NO_REK
WHERE transaksi.SETOR.TANGGAL_SETOR = @id1
select * from transaksi.SETOR

exec view_TRANSAKSI_SETOR'2019-03-12'	

drop procedure view_TRANSAKSI_SETOR
 /*PROCEDURE VIEW_TRANSAKSI_TARIK*/
 create procedure view_TRANSAKSI_TARIK
 @id2 char(20)
 as
 select human.PENDAFTARAN_NASABAH.NAMA_NASABAH,human.NASABAH.NO_REK,transaksi.TARIK.JUMLAH_TARIK,
		transaksi.TARIK.TANGGAL_TARIK
 from   human.PENDAFTARAN_NASABAH INNER JOIN
		human.NASABAH ON human.PENDAFTARAN_NASABAH.ID_NASABAH = human.NASABAH.ID_NASABAH INNER JOIN
		transaksi.TARIK on human.NASABAH.NO_REK=transaksi.TARIK.NO_REK
 Where transaksi.TARIK.TANGGAL_TARIK = @id2
 select * from transaksi.TARIK
 exec view_TRANSAKSI_TARIK'2019-11-28'
...
select * from transaksi.TARIK
 insert into transaksi.TARIK values
 ('TRK010','7000000005',' 5000','2019-09-08','T002')
insert into transaksi.SETOR values 
('STR010','7000000005',' 10000','2019-09-08','T002')
...
SELECT * FROM HUMAN.NASABAH WHERE ID_NASABAH='N0000000003'
SELECT * FROM HUMAN.PENDAFTARAN_NASABAH WHERE NAMA_NASABAH ='RAMADIAN A'